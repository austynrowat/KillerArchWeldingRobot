...
(cl:defmethod cl:initialize-instance :after ((m <IntArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name irig-msg:<IntArray> is deprecated: use irig-msg:IntArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <IntArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader irig-msg:data-val is deprecated.  Use irig-msg:data instead.")
  (data m))
